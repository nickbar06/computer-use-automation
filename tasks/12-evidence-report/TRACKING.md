# Task: Evidence and REPORT.md

**Date**: 2026-09-21
**Status**: todo
**Spec**: `tasks/12-evidence-report/README.md`
...
README demo path, REPORT seven headings, evidence folders including a real discovery run.

### Success criteria

Clone-and-replay works without a key; discovery JSONL is live; no secrets in git.
