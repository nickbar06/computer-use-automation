...
**Date**: 2026-09-21
**Status**: todo
**Spec**: `tasks/03-artifact-schema/README.md`
...
Zod capability schema 1.0 plus hand-authored lookup_savings and open_subaccount JSON and northlake overlay.

### Success criteria

parse() accepts shipped JSON; overlay does not mutate base; URLs canonicalize member ids.
