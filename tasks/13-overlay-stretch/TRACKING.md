# Task: Tenant overlay stretch

**Date**: 2026-09-21
**Status**: todo
**Spec**: `tasks/13-overlay-stretch/README.md`
...
Northlake overlay test + REPORT heading 4. Optional; only after 12 done.

### Success criteria

With overlay success; without overlay not a silent wrong-page success.
