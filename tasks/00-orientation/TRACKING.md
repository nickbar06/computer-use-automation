...
**Date**: 2026-09-21
**Status**: todo
**Spec**: `tasks/00-orientation/README.md`
...
Read assignment docs until you can explain discovery vs replay and the error taxonomy without the PDF.

### Success criteria

Lesson questions answered; seven REPORT headings recalled; locked stack known.
