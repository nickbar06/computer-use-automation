# Task: Discovery agent loop

**Date**: 2026-09-21
**Status**: todo
**Spec**: `tasks/06-discovery-loop/README.md`
...
LLM observe-decide-act with one act tool until done/stuck/max steps. Redact before model and logs.

### Success criteria

Without key: clear error. With key: lookup goal reaches done or task stays blocked. No secrets in JSONL.
