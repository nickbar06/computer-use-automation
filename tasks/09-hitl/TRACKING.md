# Task: HITL same-session handoff

**Date**: 2026-09-21
**Status**: todo
**Spec**: `tasks/09-hitl/README.md`
...
SessionControl owner agent|human, intervention files, poll RESUME, tracing on existing context.

### Success criteria

Unit: resume flips owner. Demo: no second browser.launch for the human.
